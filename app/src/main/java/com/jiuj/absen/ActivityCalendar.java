...
public class ActivityCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarView.addEvent(16,9,2018);
        calendarView.addEvent(17,9,2018);
        calendarView.addEvent(18,9,2018);
        calendarView.addEvent(19,9,2018);
        ...
        calendarView.setOnDayClickListener(new CalendarView.OnDayClickListener() {
            ...
            public void onClick(int day, int month, int year, boolean hasEvent) {
                Toast.makeText(ActivityCalendar.this, day+"/"+month+"/"+year + " hasEvent="+hasEvent, Toast.LENGTH_SHORT).show();
                if (hasEvent) {
